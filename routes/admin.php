...
use App\Http\Controllers\Admin\SellCoinController;
...
use App\Http\Controllers\Admin\NannyCareController;
use App\Http\Controllers\Admin\BuyCoinLogController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::controller(MoneyOutController::class)->prefix('money-out')->name('money.out.')->group(function () {
        ...
        Route::put('status/update/{id}', 'statusUpdate')->name('status.update');
        Route::put('rejected', 'rejected')->name('rejected');
    });

    //Buy Coin Logs
    Route::controller(BuyCoinLogController::class)->prefix('buy-coin')->name('buy.coin.logs.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::get('pending', 'pending')->name('pending');
        Route::get('complete', 'complete')->name('complete');
        Route::get('canceled', 'canceled')->name('canceled');
        Route::put('approved', 'approved')->name('approved');
        Route::put('rejected', 'rejected')->name('rejected');
        Route::get('details/{id}', 'buyCoinDetails')->name('details');
    });
    //Sell Coin Logs
    Route::controller(SellCoinController::class)->prefix('sell-coin')->name('sell.coin.')->group(function () {
        ...
        Route::put('approved', 'approved')->name('approved');
        Route::put('rejected', 'rejected')->name('rejected');
        Route::get('details/{id}', 'sellCoinDetails')->name('details');
    });

    //Add Service Area
    Route::controller(ServiceAreaController::class)->prefix('service-area')->name('service.area.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::post('store', 'store')->name('store');
        Route::put('update', 'update')->name('update');
        Route::delete('delete', 'delete')->name('delete');
    ...
    // Nanny Care Section
    Route::controller(NannyCareController::class)->prefix('nannies')->name('nannies.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::get('active', 'active')->name('active');
        Route::get('banned', 'banned')->name('banned');
        Route::get('email/unverified', 'emailUnverified')->name('email.unverified');
    ...
    //Subscriber List
    Route::controller(SubscriberListController::class)->prefix('subscribers')->name('subscribers')->group(function () {
        Route::get('/', 'index');
        Route::post('send/mail', 'subscriberMail')->name('send.mail');
    });
    //Contact List
    Route::controller(ContactListController::class)->prefix('contacts')->name('contacts.')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('send/mail', 'contactSendMail')->name('send.mail');
    });
