            ...
            <div class="row">
                <div class="col-xxxl-4 col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                <h6 class="title">{{ __('Active Service') }}</h6>
                                <div class="user-info">
                                    <h2 class="user-count">{{ $data['active_service'] }}
                                    </h2>
                                </div>
                            </div>
                            <div class="right">
                ...
                <div class="col-xxxl-4 col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                <h6 class="title">{{ __('Baby Service') }}</h6>
                                <div class="user-info">
                                    <h2 class="user-count">
                                        {{ $data['baby_service'] }}</h2>
                                </div>
                            </div>
                            <div class="right">
                                <div class="dashboard-icon">
                ...
                <div class="col-xxxl-4 col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                <h6 class="title">{{ __('Pet Service') }}</h6>
                                <div class="user-info">
                                    <h2 class="user-count">
                                        {{ $data['pet_service'] }}</h2>
                                </div>
                ...
                <div class="col-xxxl-4 col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                <h6 class="title">{{ __('Total Booking') }}</h6>
                                <div class="user-info">
                                    <h2 class="user-count">
                                        {{ $data['total_booking'] }}</h2>
                                </div>
                            </div>
                            <div class="right">
                                <div class="dashboard-icon">
        ...
        <div class="card-body">
            <form class="card-form">
                <div class="row align-items-center mb-10-none">
                    <div class="col-xxl-4 col-xl-12 col-lg-12 form-group">
