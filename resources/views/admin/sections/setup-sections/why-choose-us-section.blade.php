...
@section('breadcrumb')
    @include('admin.components.breadcrumb', [
        ...
        'active' => __('Why Choose Us Section'),
    ])
@endsection
...
@section('content')
    ...
    <div id="why-choose-us-edit" class="mfp-hide large">
...
@push('script')
    <script>
        ...
        openModalWhenError("why-choose-us-edit", "#why-choose-us-edit");
        ...
        $(".edit-modal-button").click(function() {
            ...
            var editModal = $("#why-choose-us-edit");
            ...
            $.each(languages, function(index, item) {
                ...
                editModal.find("textarea[name=" + item.code + "_item_description_edit]").val(oldData
                    .language[
                        item.code]?.item_description);
            });
            editModal.find("input[name=image]").attr("data-preview-name", oldData.image);
            fileHolderPreviewReInit("#why-choose-us-edit input[name=image]");
            openModalBySelector("#why-choose-us-edit");
