            ...
            <form class="modal-form" method="POST" action="{{ setRoute('admin.setup.sections.blog.update') }}"
                ...
                <div class="row mb-10-none mt-3">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="{{ $default_lang_code . '_description' }}" class="form--control rich-text-editor">
                                    {!! old($default_lang_code . '_description', $data->description->language->$default_lang_code->description) !!}</textarea>
                                </div>
                            ...
                            @foreach ($languages as $item)
                                ...
                                <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif"
                                    ...
                                    <div class="form-group">
                                        <label>{{ 'Description*' }}</label>
                                        <textarea name="{{ $lang_code . '_description' }}" class="form--control rich-text-editor">
                                            {!! old(@$lang_code . '_description', @$data->description->language->$lang_code->description) !!}
                                        </textarea>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <select name="tags[]" multiple id="" class="select2-auto-tokenize">
