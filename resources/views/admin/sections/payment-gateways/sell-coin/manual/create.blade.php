...
@section('content')
    <form action="{{ setRoute('admin.payment.gateway.store', ['sell-coin', 'manual']) }}" method="POST"
        enctype="multipart/form-data">
        @csrf
        @include('admin.components.payment-gateway.manual.gateway-header', ['title' => 'Sell Coin'])
