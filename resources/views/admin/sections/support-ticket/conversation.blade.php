        ...
        <div class="support-card-wrapper">
            <div class="card-header">
                <div class="card-header-user-area">
                    @php
                        if (isset($support_ticket->user)) {
                            $image = $support_ticket->user->image;
                        } else {
                            $image = $support_ticket->nanny->image;
                    } @endphp

                    <img class="avatar" src="{{ get_image($image, 'user-profile') }}" alt="client">
                    <div class="card-header-user-content">
                        <h6 class="title">{{ $support_ticket->user->fullname ?? $support_ticket->nanny->fullname }}</h6>
