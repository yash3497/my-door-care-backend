    ...
    <div class="account-wrapper">
        ...
        <form class="account-form" action="{{ setRoute('admin.login.submit') }}" method="POST">
            ...
            <div class="form-group">
                <input type="text" class="@error('email') is-invalid @enderror" title="Enter Username" required
            ...
            <div class="form-group">
                <div class="forgot-item">
                    <p><a href="{{ setRoute('admin.password.forgot') }}" class="text--base">{{ __('Forgot Password?') }}</a>
                    </p>
                </div>
            </div>
