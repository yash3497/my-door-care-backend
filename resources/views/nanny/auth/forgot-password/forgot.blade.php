...
@section('content')
    <section class="forgot-password pt-60 pb-80">
        <div class="container">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="forgot-password-area">
                        <div class="account-wrapper-area">
                            ...
                            <form action="{{ setRoute('nanny.password.forgot.send.code') }}" class="account-form"
                                method="POST">
                                @csrf
                                    ...
                                    <div class="col-lg-12 text-center">
                                        <div class="account-item">
                                            <label>{{ __('Already Have An Account?') }} <a href="{{ route('nanny.login') }}"
                                                    class="account-control-btn text--base">{{ __('Login Now') }}</a></label>
                                        </div>
                                    </div>
                                </div>
                            </form>
