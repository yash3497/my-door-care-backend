...
@section('content')
    <section class="login ptb-80">
        <div class="container mx-auto">
            <div class="row">
                <div class="col-md-6 d-grid my-auto">
                    <div class="login-img">
                        <img src="{{ get_image(@$login->value->image, 'site-section') }}" alt="Image">
                    </div>
                </div>
                ...
                <div class="col-md-6 my-auto">
                    <div class="content">
                        <div class="my-4">
                            <h3 class="pb-2 text-capitalize fw-bold">
                                {{ @$login->value->language->$lang->heading }}
                                {{ $current_route_name == 'user.login' ? __('User') : '' }}
                            </h3>
                        </div>
                        <form action="{{ route('user.login.submit') }}" method="POST">
                            ...
                            <div class="forgot-item">
                                <label><a href="{{ route('user.password.forgot') }}"
