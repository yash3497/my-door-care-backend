                    ...
                    <div class="verification-otp-area">
                        <div class="account-wrapper-area otp-verification">
                            <div class="account-logo text-center">
                                <a href="{{ route('user.login') }}" class="site-logo">
                            ...
                            <form action="{{ setRoute('user.authorize.mail.verify', $token) }}" class="account-form"
                                method="POST">
                                @csrf
                                <div class="row ml-b-20 text-center">
                                    ...
                                    <div class="col-lg-12 form-group">
                                        <div class="time-area">You can resend the code after <span id="time"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 text-center">
                                        <div class="account-item">
                                            <label>{{ 'Already Have An Account?' }} <a href="{{ route('user.login') }}"
