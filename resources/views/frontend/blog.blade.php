...
@section('content')
    ...
    @endphp
    <section class="blog ptb-60 bg_img" data-background="{{ asset('public/frontend') }}/images/element/bg1.png">
                        ...
                        <div class="col-lg-4 col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('blog.details', [$blog->id, $blog->slug]) }}" class="link">{{__('Read More')}}
