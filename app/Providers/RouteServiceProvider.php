...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->routes(function () {
            ...
            Route::middleware(['system.maintenance.api'])
                ->prefix('api/v1')
                ->group(base_path('routes/api/v1/nanny_api.php'));
            ...
            Route::middleware(['web', 'auth:nanny', 'verification.guard', 'kyc.verification', 'profession.submitted', 'google.two.factor','system.maintenance'])
