...
class PaymentGatewayApi
{
    ...
    use Paypal, Stripe, Manual, FlutterwaveTrait, RazorTrait, SslcommerzTrait, QrpayTrait, PaystackTrait;
    ...
    public function getUserWallet($gateway_currency)
    {
        ...
        $user_wallet = $wallet_model::where('user_id', $user_id)->whereHas("currency", function ($q) use ($gateway_currency) {
