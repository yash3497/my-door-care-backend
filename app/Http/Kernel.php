...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'nanny.verification.guard'  => \App\Http\Middleware\NannyVerificationGuard::class,
        ...
        'kyc.verification' => \App\Http\Middleware\Nanny\KycVerification::class,
        'api.nanny' => \App\Http\Middleware\Nanny\ApiAuthenticator::class,
        'profession.submitted' => \App\Http\Middleware\Nanny\ProfessionSubmitted::class,
        'google.two.factor' => \App\Http\Middleware\Nanny\GoogleTwoFactor::class,
        'nanny.kyc' => \App\Http\Middleware\NannyKyc::class,
