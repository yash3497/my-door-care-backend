...
class SupportTicketController extends Controller
{
    ...
    public function index()
    {
        ...
        $support_tickets = UserSupportTicket::nannyTickets()->orderByDesc("id")->paginate(10);
        return view('nanny.sections.support-ticket.index', compact('page_title', 'support_tickets'));
    }
    ...
    public function create()
    {
        ...
        return view('nanny.sections.support-ticket.create', compact('page_title'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated['name']          = auth()->user()->fullname;
        ...
        return redirect()->route('nanny.support.ticket.index')->with(['success' => ['Support ticket created successfully!']]);
    }
    ...
    public function conversation($encrypt_id)
    {
        ...
        $support_ticket = UserSupportTicket::with('nanny')->findOrFail($support_ticket_id);


        $page_title = "";
        return view('nanny.sections.support-ticket.conversation', compact('page_title', 'support_ticket'));
    }
